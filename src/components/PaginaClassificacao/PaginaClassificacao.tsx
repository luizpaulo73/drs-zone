    ...
    useEffect(() => {
      async function fetchData() {
          ...
          try {
              ...
              setPilotos(pilotoData.MRData.StandingsTable.StandingsLists[0].DriverStandings || []);
              setEquipes(equipeData.MRData.StandingsTable.StandingsLists[0].ConstructorStandings || []);
              setIsLoading(false);
          } catch (error) {
